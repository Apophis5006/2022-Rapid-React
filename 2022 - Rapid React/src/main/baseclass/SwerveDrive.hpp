#include <../baseclass/BaseMotor.hpp>
#include <../baseclass/Motor.hpp>
#include <../baseclass/Servo.hpp>
...
public:
    ...
    */
    SwerveDrive(int driveMotorId = 0, int steerMotorId = 1, double originState[2] = {0}, double setState[2] = {0}) : driveMotor(driveMotorId),steerMotor(steerMotorId),baseState(originState),targetState(setState) {}
